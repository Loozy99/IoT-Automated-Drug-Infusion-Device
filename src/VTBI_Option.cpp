...
double VTBI_Option (double FlowRate){
  int digit4 = 0;
  int digit3 = 0;
  int digit2 = 0;
  int digit1 = 0;
...
//------------------------------------------------------------------------------------
  ...
  VTBI = (digit4 * 1000)+(digit3 * 100)+(digit2 * 10)+(digit1)+(decimal*0.1);
  return VTBI;
}